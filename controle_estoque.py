...
class Janelalogin:
    def __init__(self, janela):
        ...
        ttk.Label(frame_principal, text="USUÁRIO").grid(row=1, column=0, sticky='e', padx=8)
        ...
        ttk.Label(frame_principal, text="SENHA").grid(row=2, column=0, sticky='e', padx=8)
        ...
        style = ttk.Style()
        style.configure('Acess.TButton', font=('Arial', 10, 'bold'))
    ...
    def verificar_login(self):
        ...
        if usuario == "admin" and senha == "Italo@123":
...
class EstoqueApp:
    ...
    def get_produto_selecionado(self):
        ...
        if not sel:
            messagebox.showwarning("ATENÇÃO", "Selecione o produto na tabela!")
            return None
